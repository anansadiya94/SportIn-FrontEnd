...
class Pendientes extends StatefulWidget { 
  @override
  PendientesState createState() => new PendientesState();
}

class PendientesState extends State<Pendientes> {
        ...
        child: new FutureBuilder(
          ...
          builder: (BuildContext context, AsyncSnapshot<http.Response> response) {
            if (!response.hasData)
              ...
              return new PendientesData(json);
            }
          }
        )
      ),
...
class PendientesData extends StatelessWidget {
  final List data;
  PendientesData(this.data);
              ...
              child: new Column(
                children: <Widget>[
                  new ListTile(
                    ...
                    subtitle: new Text('${_nombre[index]} no ha aceptado aún la oferta -${_oferta[index]}-.',),
                  ),
                ],
              ),
            ),
