...
class CrearOfertaJ extends StatefulWidget {
  final int _searchedRoleId;
  CrearOfertaJ(this._searchedRoleId);
  @override
  CrearOfertaJState createState() => new CrearOfertaJState(_searchedRoleId);
}

class CrearOfertaJState extends State<CrearOfertaJ> {
  var token = globals.tokenPerUser;
  final int _searchedRoleId;
  CrearOfertaJState(this._searchedRoleId);
              ...
              children: [
                new Column(
                  ...
                  children: <Widget>[
                    ...
                    new Text('En busqueda de jugador', style: new TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold),),
                    new TextFormField(
